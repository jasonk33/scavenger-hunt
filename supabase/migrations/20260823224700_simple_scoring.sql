...
--
-- This updates the view after 20260823224600_competitive_scoring.sql has
-- already been run. The old threshold and cap columns remain for backwards
-- compatibility but are no longer used by the application or the scoring view.
